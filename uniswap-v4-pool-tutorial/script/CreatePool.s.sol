...
contract CreatePool is Script {
    ...
    function run() public {
        ...
        ////////////////////////////////////////////// LAUNCHING TOKENS //////////////////////////////////////////////
        MockToken token0 = new MockToken("Labu Land", "LABU", 18, 1_000_000_000 ether); // One billion tokens minted
        MockToken token1 = new MockToken("Labu Land", "LABU", 18, 1_000_000_000 ether); // One billion tokens minted
        ...
        ////////////////////////////////////////////// CREATE POOL //////////////////////////////////////////////
        address DOG = address(token0); // DOG
        ...
        PoolKey memory pool = PoolKey({
          currency0: Currency.wrap(DOG), // DOG
